...
public class FortuneEmployee {
	...
	public static void main(String[] args) {
		...
		EmployeeInfo employee = new EmployeeInfo("Farzin", 01);
		EmployeeInfo.setCompanyName("Apollo");
		employee.setSalary(100000);
		employee.setSsn("666.666.6666");
		employee.setEmployeeId(01);
		employee.setEmail("farzinwashere@gmail.com");
		employee.setDate_of_birth("00/00/0000");
